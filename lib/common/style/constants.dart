...
class ThemeConstants extends ThemeExtension<ThemeConstants> {
  ...
  ThemeExtension<ThemeConstants> copyWith({
    ...
    double? lightColorOpacity,
    double? mediumColorOpacity,
    ...
    return ThemeConstants(
      ...
      lightColorOpacity: lightColorOpacity ?? this.lightColorOpacity,
      mediumColorOpacity: mediumColorOpacity ?? this.mediumColorOpacity,
