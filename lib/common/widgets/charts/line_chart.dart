...
class _LineChart extends StatelessWidget {
  ...
  FlBorderData get borderData => FlBorderData(
    ...
    border: Border(
      bottom: BorderSide(
          color: _AppColors.primary.withOpacity( 0.2), width: 4),
  ...
  LineChartBarData get lineChartBarData1_1 => LineChartBarData(
    isCurved: true,
    color: _AppColors.contentColorGreen,
    barWidth: 8,
  ...
  LineChartBarData get lineChartBarData1_2 => LineChartBarData(
    isCurved: true,
    color: _AppColors.contentColorPink,
    barWidth: 8,
    isStrokeCapRound: true,
    dotData: const FlDotData(show: false),
    belowBarData: BarAreaData(
      show: false,
      color: _AppColors.contentColorPink.withOpacity( 0),
    ),
    spots: const [
      FlSpot(1, 1),
      FlSpot(3, 2.8),
  ...
  LineChartBarData get lineChartBarData1_3 => LineChartBarData(
    isCurved: true,
    color: _AppColors.contentColorCyan,
    barWidth: 8,
    isStrokeCapRound: true,
    dotData: const FlDotData(show: false),
    belowBarData: BarAreaData(show: false),
  ...
  LineChartBarData get lineChartBarData2_1 => LineChartBarData(
    isCurved: true,
    curveSmoothness: 0,
    color: _AppColors.contentColorGreen.withOpacity( 0.5),
    barWidth: 4,
    isStrokeCapRound: true,
    dotData: const FlDotData(show: false),
    belowBarData: BarAreaData(show: false),
  ...
  LineChartBarData get lineChartBarData2_2 => LineChartBarData(
    isCurved: true,
    color: _AppColors.contentColorPink.withOpacity( 0.5),
    barWidth: 4,
    isStrokeCapRound: true,
    dotData: const FlDotData(show: false),
    belowBarData: BarAreaData(
      show: true,
      color: _AppColors.contentColorPink.withOpacity( 0.2),
    ),
    spots: const [
      FlSpot(1, 1),
      FlSpot(3, 2.8),
  ...
  LineChartBarData get lineChartBarData2_3 => LineChartBarData(
    isCurved: true,
    curveSmoothness: 0,
    color: _AppColors.contentColorCyan.withOpacity( 0.5),
    barWidth: 2,
    isStrokeCapRound: true,
